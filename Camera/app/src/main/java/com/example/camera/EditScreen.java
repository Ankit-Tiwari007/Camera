...
import static com.example.camera.Home.bitmap;
import static com.example.camera.Home.imageFileName;
import static com.example.camera.Home.uri;
import static com.example.camera.Home.uri1;
...
public class EditScreen extends AppCompatActivity {
    ...
    float toRotation;
        ...
        if (croppedBitmap != null) {
            ...
            rotateBitmap = Bitmap.createBitmap(bitmapBasic, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, true);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.Selfie2);
        Rotate= findViewById(R.id.rotate);
        Save = findViewById(R.id.save);
        Crop = findViewById(R.id.crop);
        ActivityCompat.requestPermissions(EditScreen.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
